...
const doctorformSchema = z.object({
  ...
  experience: z
    ...
    .max(70, "Maximum Experience must be 70"),
  credentialUrl: z
    .string()
      ...
      className="border-emerald-900/20 hover:border-emerald-700/40 cursor-pointer transition-all">
        <CardHeader>
          <CardContent className="pt-6 pb-6 flex flex-col items-center text-center">
            ...
            <Button className="w-full mt-2 bg-emerald-600 hover:bg-emerald-700" disabled={loading}> {loading ? (
                <>
        ...
        <CardHeader>
          <CardContent className="pt-6 pb-6 flex flex-col items-center text-center">
            ...
            <Button disabled={loading} className="w-full mt-2 bg-emerald-600 hover:bg-emerald-700">Continue as Doctor</Button>
          </CardContent>
        </CardHeader>
      </Card>
